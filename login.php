        ...
        <div class="col-6">
            <div class="card">
                ...
                <form method="post" action="db/login.php">
                    ...
                    <hr/>
                    <span style="color: #7A11F7 ">Do not have an Acount ?</span> <a href="signup.php">Signup</a> 
                    <input type="submit" value="Login" name="submit" style="float:right;" class="btn btn-info">
                </form>
                </div>
